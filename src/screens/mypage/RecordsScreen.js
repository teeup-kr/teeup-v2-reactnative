...
export default function RecordsScreen() {
  ...
  const fetchProfile = useCallback(async () => {
    try {
      ...
      setUserProfile(response?.data || response || null);
    } catch (fetchError) {
  ...
  const fetchHandicap = useCallback(async (id) => {
    ...
    try {
      ...
      setHandicapInfo(response?.data || response || null);
    } catch (fetchError) {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {loading ? (
          ...
          filteredMeetings.map((meeting, index) => {
            ...
            const detailDate = meeting?.meeting_time ? formatDate(meeting.meeting_time) : '-';
            const completedDate = meeting?.rounding_completed_at ? formatDate(meeting.rounding_completed_at) : '-';
            ...
            return (
              ...
              >
                ...
                <View style={styles.actionRow}>
                  ...
                  <Button
                    variant={hasScore ? 'outline' : 'outline'}
                    size="sm"
                    style={styles.actionButton}
