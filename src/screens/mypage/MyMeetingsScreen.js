      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {loading ? (
          ...
          filteredMeetings.map((meeting, index) => {
            ...
            const type = typeConfig[meetingType] || typeConfig.ROUND;
            const statusKey = getStatusKey(meeting);
            const status = statusConfig[statusKey] || statusConfig.UPCOMING;
            const roleKey = meeting?.role || meeting?.user_role || 'PARTICIPANT';
            const role = roleConfig[roleKey] || roleConfig.PARTICIPANT;
              ...
              <Card key={meetingKey} style={styles.meetingCard}>
                ...
                <View style={styles.metaRow}>
                  <View style={styles.metaItem}>
                    ...
                    <Text style={styles.metaText}>{formatMeetingTime(meeting?.meeting_time || meeting?.date)}</Text>
                  </View>
                  <View style={styles.metaItem}>
